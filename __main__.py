...
from pulumi import export, FileAsset, ResourceOptions, Config, Output, get_project, get_stack
import pulumi_aws
...
content_bucket = pulumi_aws.s3.Bucket('contentBucket',
                                      ...
                                      loggings=[pulumi_aws.s3.BucketLoggingArgs(
